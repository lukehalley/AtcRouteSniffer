...
# Implement exponential backoff to respect API rate limits
...
"""Apply rate limiting to API requests.
    ...
    Ensures requests stay within configured limits per second and prevents
    exceeding provider rate thresholds.
    """
