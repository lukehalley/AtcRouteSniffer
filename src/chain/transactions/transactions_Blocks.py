...
async def getAllTransactionsForBlockRange(rpcUrl, returnFullTransaction=False, blockRange=1000):
    ...
    async with aio_eth.EthAioAPI(rpcUrl, max_tasks=10000) as api:
